...
def allm_f2divx_mN(mN2, Q2, yp):
    xbj = Q2 / (mN2 - pmass * pmass + Q2)
    qmin2 = (mN2 / (1 - yp) - pmass * pmass) * yp
    if xbj < 0:
        print('xbj: ', xbj)
        return 0.
    else:
        ...
        if qmin2 < Q2:
            return allm_f2(xbj, Q2) * (mN2 - pmass * pmass + Q2)
        else:
            return 0.
...
def allm_xf2_mN(mN2, Q2, yp):
    mqdiff = mN2 - pmass * pmass + Q2
    if mqdiff < 0:
        print('mN2, Q2:', mN2, Q2)
        return 0.
    xbj = Q2 / mqdiff
    qmin2 = (mN2 / (1 - yp) - pmass * pmass) * yp
    if qmin2 < Q2:
        return allm_f2(xbj, Q2) / mqdiff * (1 - qmin2 / Q2)
    else:
        return 0.
