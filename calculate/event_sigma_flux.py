...
# d^2 sigma / dy dQ^2
d_sigma = function_for_sigma.sigma_used_article(y_array, Q2, 0.3 * mb_cm)
...
def is_inner(y, Q2, z):
    ...
    return  z < function_for_sigma.sigma_used_article(y, Q2, 0.3 * mb_cm) 
...
z_rand = 10 **(sigma_range * np.random.rand(10**5) - 30.11)
